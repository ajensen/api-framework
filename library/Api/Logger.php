...
class Logger {
	...
	public function print_buffer() {
		...
		echo '<pre style="background: #ccc; padding: 10px; border: solid 1px #AAA; color: #555"><strong>Logger result:</strong><br />------------------------------<br />' . $clean_logs . '</pre>';
	
	}
	

	/**
	 * Email the buffer content
	 *
	 * @return void
	 */
	...
	public function handle_exception($exception) {
		...
		foreach ( $trace as $key => $stackPoint ) {
			...
			// Convert arguments to their appropriate type, ensure that passwords are logged as a 'string'
